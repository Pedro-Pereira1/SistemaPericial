...
public class EvidencesSLA extends Evidences{
    ...
    public EvidencesSLA(String alertId, String multipleLocations, String legitimateBehavior, String abnormalPattern, String mfaEnabled, String userContacted) {
